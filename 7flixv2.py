...
class App:
    ...
    def create_bottom_menu(self):
        ...
        tk.Button(bottom_menu_frame, text="Sobre", bg='black', fg='white', font=("Arial", 12),
                  command=lambda: messagebox.showinfo("Sobre", "7FLIX é uma plataforma de divulgar séries, seja bem-vindo")).pack(side='left', padx=10)
    ...
    def create_home_screen(self):
        self.clear_window()
        tk.Label(self.root, text="Bem-vindo ao 7FLIX", font=("Arial", 24), fg='white', bg='black').pack(pady=20)
        self.display_series()
    ...
    def display_series(self):
        ...
        columns = 4
        for index, serie in enumerate(self.series_list):
            row = index // columns
            col = index % columns
