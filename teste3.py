...
class App:
    ...
    def create_top_bar(self):
        ...
        # Apenas o botão Login na barra superior
    ...
    def create_login_screen(self):
        ...
        # Botão "Administrador" na área vermelha (abaixo dos campos de login)
        tk.Button(login_frame, text="Login Admin", command=self.admin_screen, bg='red', fg='white', font=("Arial", 12)).pack(pady=15)

        # Novo menu na parte inferior
    ...
    def create_bottom_menu(self):
        ...
        tk.Button(bottom_menu_frame, text="Ajuda", bg='black', fg='white', font=("Arial", 12),
                  command=lambda: messagebox.showinfo("Ajuda", "Bem-vindo ao 7FLIX!\nEntre com sua conta ou registre-se para continuar.")).pack(side='left', padx=10)
        tk.Button(bottom_menu_frame, text="Sobre", bg='black', fg='white', font=("Arial", 12),
                  command=lambda: messagebox.showinfo("Sobre", "7FLIX v1.0\nSua plataforma para séries favoritas!")).pack(side='left', padx=10)
